...
func (ec *Client) BlockByNumber2(ctx context.Context, number *big.Int) (*types.Block, error) {
	return ec.getBlock2(ctx, "eth_getBlockByNumber", toBlockNumArg(number), true)
}
...
func (ec *Client) getBlock2(ctx context.Context, method string, args ...interface{}) (*types.Block, error) {
	var raw json.RawMessage
	err := ec.c.CallContext(ctx, &raw, method, args...)
	if err != nil {
		return nil, err
