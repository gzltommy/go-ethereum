...
coverpkg="github.com/gzltommy/go-ethereum/..."
...
repo=$GOPATH/src/github.com/gzltommy/go-ethereum
compile_fuzzer github.com/gzltommy/go-ethereum/accounts/abi \
  FuzzABI fuzzAbi \
  $repo/accounts/abi/abifuzzer_test.go

compile_fuzzer github.com/gzltommy/go-ethereum/common/bitutil \
...
compile_fuzzer github.com/gzltommy/go-ethereum/core/vm/runtime \
  FuzzVmRuntime fuzzVmRuntime\
  $repo/core/vm/runtime/runtime_fuzz_test.go

compile_fuzzer github.com/gzltommy/go-ethereum/core/vm \
  FuzzPrecompiledContracts fuzzPrecompiledContracts\
  $repo/core/vm/contracts_fuzz_test.go,$repo/core/vm/contracts_test.go

compile_fuzzer github.com/gzltommy/go-ethereum/core/types \
  FuzzRLP fuzzRlp \
  $repo/core/types/rlp_fuzzer_test.go

compile_fuzzer github.com/gzltommy/go-ethereum/crypto/blake2b \
  Fuzz fuzzBlake2b \
  $repo/crypto/blake2b/blake2b_f_fuzz_test.go

compile_fuzzer github.com/gzltommy/go-ethereum/accounts/keystore \
  FuzzPassword fuzzKeystore \
  $repo/accounts/keystore/keystore_fuzzing_test.go

pkg=$repo/trie/
compile_fuzzer github.com/gzltommy/go-ethereum/trie \
  FuzzTrie fuzzTrie \
...
compile_fuzzer github.com/gzltommy/go-ethereum/eth/protocols/snap \
...
compile_fuzzer github.com/gzltommy/go-ethereum/tests/fuzzers/bn256 \
...
compile_fuzzer github.com/gzltommy/go-ethereum/tests/fuzzers/txfetcher \
  Fuzz fuzzTxfetcher \
  $repo/tests/fuzzers/txfetcher/txfetcher_test.go

compile_fuzzer github.com/gzltommy/go-ethereum/tests/fuzzers/bls12381 \
...
compile_fuzzer github.com/gzltommy/go-ethereum/tests/fuzzers/secp256k1 \
  Fuzz fuzzSecp256k1\
